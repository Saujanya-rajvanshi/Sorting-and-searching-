...
- [search insert position](#Search-Insert-Position) -[lc](https://leetcode.com/problems/search-insert-position/description/)
- [floor/ceil in sorted array](#FloorCeil-in-Sorted-Array) 
- [find the first or last occurrence of a given number in a sorted array](#find-the-first-or-last-occurrence-of-a-given-number-in-a-sorted-array) -[lc](https://leetcode.com/problems/find-first-and-last-position-of-element-in-sorted-array/description/)
...
- [count occurrences of a number in a sorted array with duplicates](#count-occurrences-of-a-number-in-a-sorted-array-with-duplicates)
- [search in rotated sorted array i](#search-in-rotated-sorted-array-i)  -[lc](https://leetcode.com/problems/search-in-rotated-sorted-array/description/)
- [search in rotated sorted array ii](#search-in-rotated-sorted-array-ii)  -[lc](https://leetcode.com/problems/search-in-rotated-sorted-array-ii)
- [find minimum in rotated sorted array](#find-minimum-in-rotated-sorted-array)  -[lc](https://leetcode.com/problems/find-minimum-in-rotated-sorted-array/description/)
- [find out how many times has an array been rotated](#find-out-how-many-times-has-an-array-been-rotated)  
- [single element in a sorted array](#single-element-in-a-sorted-array)  -[lc](https://leetcode.com/problems/single-element-in-a-sorted-array/)
- [find peak element](#find-peak-element)  -[lc](https://leetcode.com/problems/find-peak-element/description/)
...
- [koko eating bananas](#koko-eating-bananas) -[lc](https://leetcode.com/problems/koko-eating-bananas/description/)
- [minimum days to make m bouquets](#minimum-days-to-make-m-bouquets) -[lc](https://leetcode.com/problems/minimum-number-of-days-to-make-m-bouquets/description/)
- [find the smallest divisor](#find-the-smallest-divisor) -[lc](https://leetcode.com/problems/find-the-smallest-divisor-given-a-threshold/description/)
- [capacity to ship packages within d days](#capacity-to-ship-packages-within-d-days) -[lc](https://leetcode.com/problems/capacity-to-ship-packages-within-d-days/description/)
- [kth missing positive number](#kth-missing-positive-number) -[lc](https://leetcode.com/problems/kth-missing-positive-number/description/)
